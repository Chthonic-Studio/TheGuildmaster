...
public class GoOutOfTown
{
    ...
    public GoOutOfTown(characterTownAI characterTownAI, CharacterProfile characterProfile)
    {
    ...
    public void LeaveTown()
    {
        ...
        if (randomTownExit != null)
        {
            ...
            characterTownAI.StartCoroutine(characterTownAI.WaitAtDoor(200, 400));
        }
        else
        {
