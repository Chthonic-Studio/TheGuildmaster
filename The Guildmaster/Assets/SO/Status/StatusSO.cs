...
[CreateAssetMenu(fileName = "Status", menuName = "Skills/Status")]

public class StatusSO : BaseSO
{
    ...
    [SerializeField] public string StatusDescription;
    ...
    [Header("Affinities & Resistances Modifiers")]
