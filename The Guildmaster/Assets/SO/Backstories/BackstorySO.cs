...
[CreateAssetMenu(fileName = "Backstory", menuName = "Characters/Backstory")]

public class BackstorySO : BaseSO
{
    [Header("Backstory Info")]
    [SerializeField] public string BackstoryName;
    [SerializeField] public string BackstoryDescription;

    [Header("Backstory Stats")]
